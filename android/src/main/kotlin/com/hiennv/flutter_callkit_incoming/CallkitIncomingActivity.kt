...
class CallkitIncomingActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestedOrientation =
                if (!Utils.isTablet(this@CallkitIncomingActivity)) {
    ...
    private fun incomingData(intent: Intent) {
        ...
        if (avatarUrl != null && avatarUrl.isNotEmpty()) {
            ...
            val headers =
                    data.getSerializable(CallkitConstants.EXTRA_CALLKIT_HEADERS) as
                            HashMap<String, Any?>
        ...
        if (backgroundUrl != null && backgroundUrl.isNotEmpty()) {
            if (!backgroundUrl.startsWith("http://", true) &&
                            !backgroundUrl.startsWith("https://", true)
            ) {
                backgroundUrl =
        ...
        val client =
                OkHttpClient.Builder()
                        .addNetworkInterceptor { chain ->
                            val newRequestBuilder: okhttp3.Request.Builder =
